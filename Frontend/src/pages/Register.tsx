      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-flex items-center mb-6">
            <span className="text-3xl font-bold text-orange-500">Trav</span>
            <span className="text-3xl font-bold text-blue-500">guru</span>
          </Link>
          <h2 className="text-3xl">Create your account</h2>
          <p className="mt-2 text-gray-600">Join us to discover India's hidden gems</p>
        </div>
